...
| Tests | **2,020** unit/golden across 89 files, **+25** Playwright e2e | `npm run test` / `npm run test:e2e` |
...
**2,020 unit/golden tests across 89 files** (plus 25 Playwright e2e tests) pass today, alongside `format:check`, `lint`, `typecheck`, `build`, the audit, and `wrangler deploy --dry-run`.
