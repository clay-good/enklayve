...
| Tests | **1,994** unit/golden across 88 files, **+25** Playwright e2e | `npm run test` / `npm run test:e2e` |
...
**1,994 unit/golden tests across 88 files** (plus 25 Playwright e2e tests) pass today, alongside `format:check`, `lint`, `typecheck`, `build`, the audit, and `wrangler deploy --dry-run`.
