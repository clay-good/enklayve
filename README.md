...
| Tests | **670** unit/golden across 56 files, **+16** Playwright e2e | `npm run test` / `npm run test:e2e` |
...
**670 unit/golden tests across 56 files** (plus 16 Playwright e2e tests) pass today, alongside `format:check`, `lint`, `typecheck`, `build`, the audit, and `wrangler deploy --dry-run`.
