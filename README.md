...
| Tests | **1,211** unit/golden across 81 files, **+22** Playwright e2e | `npm run test` / `npm run test:e2e` |
...
**1,211 unit/golden tests across 81 files** (plus 22 Playwright e2e tests) pass today, alongside `format:check`, `lint`, `typecheck`, `build`, the audit, and `wrangler deploy --dry-run`.
