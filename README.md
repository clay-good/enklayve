...
- **Next: Phase 20 — the sequencers.** Bill triage (what to pay first when you can't pay everything, ranked by consequence rather than interest rate) and the dated life-event sequences for job loss, death, divorce, disability, a new child, and moving states.
